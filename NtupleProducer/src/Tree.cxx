...
void Tree::Init(TChain *ch)
{
   ...
   jet_r_AK8PFchs_pt = 0;
   jet_r_AK4PF_phi = 0;
   jet_r_AK4PchsF_phi = 0;
   jet_r_AK8PF_phi = 0;
   jet_r_AK8PFchs_phi = 0;
   genJet_pt = 0;
   genJet_eta = 0;
   genJet_phi = 0;
   genJet_m = 0;
...
//   fChain->SetMakeClass(1);
   ...
   fChain->SetBranchAddress("jet_r_AK4PF_pt", &jet_r_AK4PF_pt, &b_jet_r_AK4PF_pt);
   fChain->SetBranchAddress("jet_r_AK4PchsF_pt", &jet_r_AK4PchsF_pt, &b_jet_r_AK4PchsF_pt);
   fChain->SetBranchAddress("jet_r_AK8PF_pt", &jet_r_AK8PF_pt, &b_jet_r_AK8PF_pt);
   fChain->SetBranchAddress("jet_r_AK8PFchs_pt", &jet_r_AK8PFchs_pt, &b_jet_r_AK8PFchs_pt);
   fChain->SetBranchAddress("jet_r_AK4PF_phi", &jet_r_AK4PF_phi, &b_jet_r_AK4PF_phi);
   fChain->SetBranchAddress("jet_r_AK4PchsF_phi", &jet_r_AK4PchsF_phi, &b_jet_r_AK4PchsF_phi);
   fChain->SetBranchAddress("jet_r_AK8PF_phi", &jet_r_AK8PF_phi, &b_jet_r_AK8PF_phi);
   fChain->SetBranchAddress("jet_r_AK8PFchs_phi", &jet_r_AK8PFchs_phi, &b_jet_r_AK8PFchs_phi);
