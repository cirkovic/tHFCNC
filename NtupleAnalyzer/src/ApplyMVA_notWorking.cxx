...
void ApplyMVA::init()
{
   ...
   std::string b3j4HutSTweightsFile = _home+"/MVA_test/HutST_b3j4/weights/TMVA_HutST_b3j4_BDT.weights.xml";
   b3j4HutSTreader->BookMVA("BDTG method",b3j4HutSTweightsFile.c_str());
   std::string b3j4HctSTweightsFile = _home+"/MVA_test/HutST_b3j4/weights/TMVA_HctST_b3j4_BDT.weights.xml";
   b3j4HctSTreader->BookMVA("BDTG method",b3j4HctSTweightsFile.c_str());
   std::string b3j4HutTTweightsFile = _home+"/MVA_test/HutST_b3j4/weights/TMVA_HutTT_b3j4_BDT.weights.xml";
   b3j4HutTTreader->BookMVA("BDTG method",b3j4HutTTweightsFile.c_str());
   std::string b3j4HctTTweightsFile = _home+"/MVA_test/HutST_b3j4/weights/TMVA_HctTT_b3j4_BDT.weights.xml";
   ...
   std::string b3j3HutSTweightsFile = _home+"/MVA_test/HutST_b3j3/weights/TMVA_HutST_b3j3_BDT.weights.xml";
   b3j3HutSTreader->BookMVA("BDTG method",b3j3HutSTweightsFile.c_str());
   std::string b3j3HctSTweightsFile = _home+"/MVA_test/HutST_b3j3/weights/TMVA_HctST_b3j3_BDT.weights.xml";
   b3j3HctSTreader->BookMVA("BDTG method",b3j3HctSTweightsFile.c_str());
   std::string b3j3HutTTweightsFile = _home+"/MVA_test/HutST_b3j3/weights/TMVA_HutTT_b3j3_BDT.weights.xml";
   b3j3HutTTreader->BookMVA("BDTG method",b3j3HutTTweightsFile.c_str());
   std::string b3j3HctTTweightsFile = _home+"/MVA_test/HutST_b3j3/weights/TMVA_HctTT_b3j3_BDT.weights.xml";
   ...
   std::string b2j4HutSTweightsFile = _home+"/MVA_test/HutST_b2j4/weights/TMVA_HutST_b2j4_BDT.weights.xml";
   b2j4HutSTreader->BookMVA("BDTG method",b2j4HutSTweightsFile.c_str());
   std::string b2j4HctSTweightsFile = _home+"/MVA_test/HutST_b2j4/weights/TMVA_HctST_b2j4_BDT.weights.xml";
   b2j4HctSTreader->BookMVA("BDTG method",b2j4HctSTweightsFile.c_str());
   std::string b2j4HutTTweightsFile = _home+"/MVA_test/HutST_b2j4/weights/TMVA_HutTT_b2j4_BDT.weights.xml";
   b2j4HutTTreader->BookMVA("BDTG method",b2j4HutTTweightsFile.c_str());
   std::string b2j4HctTTweightsFile = _home+"/MVA_test/HutST_b2j4/weights/TMVA_HctTT_b2j4_BDT.weights.xml";
