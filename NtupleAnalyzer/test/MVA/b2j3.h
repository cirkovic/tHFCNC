...
void b2j3(std::string imva)
{   
   // tH Hut vs ttbar
   if( imva == "HutSTallb2j3" || imva == "HutSTeb2j3" || imva == "HutSTmb2j3" )
     {
	std::string outfileName = "TMVA_HutST_all_b2j3";
	if( imva == "HutSTeb2j3" ) outfileName = "TMVA_HutST_e_b2j3";
	else if( imva == "HutSTmb2j3" ) outfileName = "TMVA_HutST_m_b2j3";
	...
	std::string trName = "tr_all_b2j3";
	if( imva == "HutSTeb2j3" ) trName = "tr_e_b2j3";
	else if( imva == "HutSTmb2j3" ) trName = "tr_m_b2j3";
   ...
   // tH Hct vs ttbar
   if( imva == "HctSTallb2j3" || imva == "HctSTeb2j3" || imva == "HctSTmb2j3" )
     {
	std::string outfileName = "TMVA_HctST_all_b2j3";
	if( imva == "HctSTeb2j3" ) outfileName = "TMVA_HctST_e_b2j3";
	else if( imva == "HctSTmb2j3" ) outfileName = "TMVA_HctST_m_b2j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b2j3";
	if( imva == "HctSTeb2j3" ) trName = "tr_e_b2j3";
	else if( imva == "HctSTmb2j3" ) trName = "tr_m_b2j3";
   ...
   // ttbar Hut vs ttbar
   else if( imva == "HutTTallb2j3" || imva == "HutTTeb2j3" || imva == "HutTTmb2j3" )
     {
	std::string outfileName = "TMVA_HutTT_all_b2j3";
	if( imva == "HutTTeb2j3" ) outfileName = "TMVA_HutTT_e_b2j3";
	else if( imva == "HutTTmb2j3" ) outfileName = "TMVA_HutTT_m_b2j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b2j3";
	if( imva == "HutTTeb2j3" ) trName = "tr_e_b2j3";
	else if( imva == "HutTTmb2j3" ) trName = "tr_m_b2j3";
   ...
   // ttbar Hct vs ttbar
   else if( imva == "HctTTallb2j3" || imva == "HctTTeb2j3" || imva == "HctTTmb2j3" )
     {
	std::string outfileName = "TMVA_HctTT_all_b2j3";
	if( imva == "HctTTeb2j3" ) outfileName = "TMVA_HctTT_e_b2j3";
	else if( imva == "HctTTmb2j3" ) outfileName = "TMVA_HctTT_m_b2j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b2j3";
	if( imva == "HctTTeb2j3" ) trName = "tr_e_b2j3";
	else if( imva == "HctTTmb2j3" ) trName = "tr_m_b2j3";
