...
void b0j3(std::string imva)
{   
   // tH Hut vs ttbar
   if( imva == "HutSTallb0j3" || imva == "HutSTeb0j3" || imva == "HutSTmb0j3" )
     {
	std::string outfileName = "TMVA_HutST_all_b0j3";
	if( imva == "HutSTeb0j3" ) outfileName = "TMVA_HutST_e_b0j3";
	else if( imva == "HutSTmb0j3" ) outfileName = "TMVA_HutST_m_b0j3";
	...
	std::string trName = "tr_all_b0j3";
	if( imva == "HutSTeb0j3" ) trName = "tr_e_b0j3";
	else if( imva == "HutSTmb0j3" ) trName = "tr_m_b0j3";
   ...
   // tH Hct vs ttbar
   if( imva == "HctSTallb0j3" || imva == "HctSTeb0j3" || imva == "HctSTmb0j3" )
     {
	std::string outfileName = "TMVA_HctST_all_b0j3";
	if( imva == "HctSTeb0j3" ) outfileName = "TMVA_HctST_e_b0j3";
	else if( imva == "HctSTmb0j3" ) outfileName = "TMVA_HctST_m_b0j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b0j3";
	if( imva == "HctSTeb0j3" ) trName = "tr_e_b0j3";
	else if( imva == "HctSTmb0j3" ) trName = "tr_m_b0j3";
   ...
   // ttbar Hut vs ttbar
   else if( imva == "HutTTallb0j3" || imva == "HutTTeb0j3" || imva == "HutTTmb0j3" )
     {
	std::string outfileName = "TMVA_HutTT_all_b0j3";
	if( imva == "HutTTeb0j3" ) outfileName = "TMVA_HutTT_e_b0j3";
	else if( imva == "HutTTmb0j3" ) outfileName = "TMVA_HutTT_m_b0j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b0j3";
	if( imva == "HutTTeb0j3" ) trName = "tr_e_b0j3";
	else if( imva == "HutTTmb0j3" ) trName = "tr_m_b0j3";
   ...
   // ttbar Hct vs ttbar
   else if( imva == "HctTTallb0j3" || imva == "HctTTeb0j3" || imva == "HctTTmb0j3" )
     {
	std::string outfileName = "TMVA_HctTT_all_b0j3";
	if( imva == "HctTTeb0j3" ) outfileName = "TMVA_HctTT_e_b0j3";
	else if( imva == "HctTTmb0j3" ) outfileName = "TMVA_HctTT_m_b0j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b0j3";
	if( imva == "HctTTeb0j3" ) trName = "tr_e_b0j3";
	else if( imva == "HctTTmb0j3" ) trName = "tr_m_b0j3";
