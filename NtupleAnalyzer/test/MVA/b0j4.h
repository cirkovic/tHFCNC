...
void b0j4(std::string imva)
{   
   // tH Hut vs ttbar
   if( imva == "HutSTallb0j4" || imva == "HutSTeb0j4" || imva == "HutSTmb0j4" )
     {
	std::string outfileName = "TMVA_HutST_all_b0j4";
	if( imva == "HutSTeb0j4" ) outfileName = "TMVA_HutST_e_b0j4";
	else if( imva == "HutSTmb0j4" ) outfileName = "TMVA_HutST_m_b0j4";
	...
	std::string trName = "tr_all_b0j4";
	if( imva == "HutSTeb0j4" ) trName = "tr_e_b0j4";
   ...
   // tH Hct vs ttbar
   if( imva == "HctSTallb0j4" || imva == "HctSTeb0j4" || imva == "HctSTmb0j4" )
     {
	std::string outfileName = "TMVA_HctST_all_b0j4";
	if( imva == "HctSTeb0j4" ) outfileName = "TMVA_HctST_e_b0j4";
	else if( imva == "HctSTmb0j4" ) outfileName = "TMVA_HctST_m_b0j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b0j4";
	if( imva == "HctSTeb0j4" ) trName = "tr_e_b0j4";
   ...
   // ttbar Hut vs ttbar
   else if( imva == "HutTTallb0j4" || imva == "HutTTeb0j4" || imva == "HutTTmb0j4" )
     {
	std::string outfileName = "TMVA_HutTT_all_b0j4";
	if( imva == "HutTTeb0j4" ) outfileName = "TMVA_HutTT_e_b0j4";
	else if( imva == "HutTTmb0j4" ) outfileName = "TMVA_HutTT_m_b0j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b0j4";
	if( imva == "HutTTeb0j4" ) trName = "tr_e_b0j4";
   ...
   // ttbar Hct vs ttbar
   else if( imva == "HctTTallb0j4" || imva == "HctTTeb0j4" || imva == "HctTTmb0j4" )
     {
	std::string outfileName = "TMVA_HctTT_all_b0j4";
	if( imva == "HctTTeb0j4" ) outfileName = "TMVA_HctTT_e_b0j4";
	else if( imva == "HctTTmb0j4" ) outfileName = "TMVA_HctTT_m_b0j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b0j4";
	if( imva == "HctTTeb0j4" ) trName = "tr_e_b0j4";
