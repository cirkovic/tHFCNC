...
void b2j4(std::string imva)
{   
   // tH Hut vs ttbar
   if( imva == "HutSTallb2j4" || imva == "HutSTeb2j4" || imva == "HutSTmb2j4" )
     {
	std::string outfileName = "TMVA_HutST_all_b2j4";
	if( imva == "HutSTeb2j4" ) outfileName = "TMVA_HutST_e_b2j4";
	else if( imva == "HutSTmb2j4" ) outfileName = "TMVA_HutST_m_b2j4";
	...
	std::string trName = "tr_all_b2j4";
	if( imva == "HutSTeb2j4" ) trName = "tr_e_b2j4";
	else if( imva == "HutSTmb2j4" ) trName = "tr_m_b2j4";
   ...
   // tH Hct vs ttbar
   if( imva == "HctSTallb2j4" || imva == "HctSTeb2j4" || imva == "HctSTmb2j4" )
     {
	std::string outfileName = "TMVA_HctST_all_b2j4";
	if( imva == "HctSTeb2j4" ) outfileName = "TMVA_HctST_e_b2j4";
	else if( imva == "HctSTmb2j4" ) outfileName = "TMVA_HctST_m_b2j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b2j4";
	if( imva == "HctSTeb2j4" ) trName = "tr_e_b2j4";
	else if( imva == "HctSTmb2j4" ) trName = "tr_m_b2j4";
   ...
   // ttbar Hut vs ttbar
   else if( imva == "HutTTallb2j4" || imva == "HutTTeb2j4" || imva == "HutTTmb2j4" )
     {
	std::string outfileName = "TMVA_HutTT_all_b2j4";
	if( imva == "HutTTeb2j4" ) outfileName = "TMVA_HutTT_e_b2j4";
	else if( imva == "HutTTmb2j4" ) outfileName = "TMVA_HutTT_m_b2j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b2j4";
	if( imva == "HutTTeb2j4" ) trName = "tr_e_b2j4";
	else if( imva == "HutTTmb2j4" ) trName = "tr_m_b2j4";
   ...
   // ttbar Hct vs ttbar
   else if( imva == "HctTTallb2j4" || imva == "HctTTeb2j4" || imva == "HctTTmb2j4" )
     {
	std::string outfileName = "TMVA_HctTT_all_b2j4";
	if( imva == "HctTTeb2j4" ) outfileName = "TMVA_HctTT_e_b2j4";
	else if( imva == "HctTTmb2j4" ) outfileName = "TMVA_HctTT_m_b2j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b2j4";
	if( imva == "HctTTeb2j4" ) trName = "tr_e_b2j4";
	else if( imva == "HctTTmb2j4" ) trName = "tr_m_b2j4";
