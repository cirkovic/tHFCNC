...
void b3j4(std::string imva)
{   
   // tH Hut vs ttbar
   if( imva == "HutSTallb3j4" || imva == "HutSTeb3j4" || imva == "HutSTmb3j4" )
     {
	std::string outfileName = "TMVA_HutST_all_b3j4";
	if( imva == "HutSTeb3j4" ) outfileName = "TMVA_HutST_e_b3j4";
	else if( imva == "HutSTmb3j4" ) outfileName = "TMVA_HutST_m_b3j4";
	...
	std::string trName = "tr_all_b3j4";
	if( imva == "HutSTeb3j4" ) trName = "tr_e_b3j4";
	else if( imva == "HutSTmb3j4" ) trName = "tr_m_b3j4";
   ...
   // tH Hct vs ttbar
   if( imva == "HctSTallb3j4" || imva == "HctSTeb3j4" || imva == "HctSTmb3j4" )
     {
	std::string outfileName = "TMVA_HctST_all_b3j4";
	if( imva == "HctSTeb3j4" ) outfileName = "TMVA_HctST_e_b3j4";
	else if( imva == "HctSTmb3j4" ) outfileName = "TMVA_HctST_m_b3j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b3j4";
	if( imva == "HctSTeb3j4" ) trName = "tr_e_b3j4";
	else if( imva == "HctSTmb3j4" ) trName = "tr_m_b3j4";
   ...
   // ttbar Hut vs ttbar
   else if( imva == "HutTTallb3j4" || imva == "HutTTeb3j4" || imva == "HutTTmb3j4" )
     {
	std::string outfileName = "TMVA_HutTT_all_b3j4";
	if( imva == "HutTTeb3j4" ) outfileName = "TMVA_HutTT_e_b3j4";
	else if( imva == "HutTTmb3j4" ) outfileName = "TMVA_HutTT_m_b3j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b3j4";
	if( imva == "HutTTeb3j4" ) trName = "tr_e_b3j4";
	else if( imva == "HutTTmb3j4" ) trName = "tr_m_b3j4";
   ...
   // ttbar Hct vs ttbar
   else if( imva == "HctTTallb3j4" || imva == "HctTTeb3j4" || imva == "HctTTmb3j4" )
     {
	std::string outfileName = "TMVA_HctTT_all_b3j4";
	if( imva == "HctTTeb3j4" ) outfileName = "TMVA_HctTT_e_b3j4";
	else if( imva == "HctTTmb3j4" ) outfileName = "TMVA_HctTT_m_b3j4";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b3j4";
	if( imva == "HctTTeb3j4" ) trName = "tr_e_b3j4";
	else if( imva == "HctTTmb3j4" ) trName = "tr_m_b3j4";
