...
void b1j3(std::string imva)
{   
   // tH Hut vs ttbar
   if( imva == "HutSTallb1j3" || imva == "HutSTeb1j3" || imva == "HutSTmb1j3" )
     {
	std::string outfileName = "TMVA_HutST_all_b1j3";
	if( imva == "HutSTeb1j3" ) outfileName = "TMVA_HutST_e_b1j3";
	else if( imva == "HutSTmb1j3" ) outfileName = "TMVA_HutST_m_b1j3";
	...
	std::string trName = "tr_all_b1j3";
	if( imva == "HutSTeb1j3" ) trName = "tr_e_b1j3";
	else if( imva == "HutSTmb1j3" ) trName = "tr_m_b1j3";
   ...
   // tH Hct vs ttbar
   if( imva == "HctSTallb1j3" || imva == "HctSTeb1j3" || imva == "HctSTmb1j3" )
     {
	std::string outfileName = "TMVA_HctST_all_b1j3";
	if( imva == "HctSTeb1j3" ) outfileName = "TMVA_HctST_e_b1j3";
	else if( imva == "HctSTmb1j3" ) outfileName = "TMVA_HctST_m_b1j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b1j3";
	if( imva == "HctSTeb1j3" ) trName = "tr_e_b1j3";
	else if( imva == "HctSTmb1j3" ) trName = "tr_m_b1j3";
   ...
   // ttbar Hut vs ttbar
   else if( imva == "HutTTallb1j3" || imva == "HutTTeb1j3" || imva == "HutTTmb1j3" )
     {
	std::string outfileName = "TMVA_HutTT_all_b1j3";
	if( imva == "HutTTeb1j3" ) outfileName = "TMVA_HutTT_e_b1j3";
	else if( imva == "HutTTmb1j3" ) outfileName = "TMVA_HutTT_m_b1j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b1j3";
	if( imva == "HutTTeb1j3" ) trName = "tr_e_b1j3";
	else if( imva == "HutTTmb1j3" ) trName = "tr_m_b1j3";
   ...
   // ttbar Hct vs ttbar
   else if( imva == "HctTTallb1j3" || imva == "HctTTeb1j3" || imva == "HctTTmb1j3" )
     {
	std::string outfileName = "TMVA_HctTT_all_b1j3";
	if( imva == "HctTTeb1j3" ) outfileName = "TMVA_HctTT_e_b1j3";
	else if( imva == "HctTTmb1j3" ) outfileName = "TMVA_HctTT_m_b1j3";
	TFile* outfile = TFile::Open((outfileName+".root").c_str(),"RECREATE");
	...
	std::string trName = "tr_all_b1j3";
	if( imva == "HctTTeb1j3" ) trName = "tr_e_b1j3";
	else if( imva == "HctTTmb1j3" ) trName = "tr_m_b1j3";
